  ...
  Widget build(BuildContext context) {
    ...
    useEffect(() {
      ...
      final chatNewMessageNotify =
          eventListener.addListener(EventType.onChatNewMessageNotify, (data) async {
            data = data as Map;
        ZoomVideoSdkChatMessage newMessage =
            ZoomVideoSdkChatMessage.fromJson(jsonDecode(data['message']));
      ...
      eventListener.addListener(EventType.onChatDeleteMessageNotify, (data) async {
        data = data as Map;
        var toRemove = [];
